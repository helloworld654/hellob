...
// #define I2C_MASTER_SCL_IO 5               /*!< gpio number for I2C master clock */    // set the gpio num same to default idf sdk
// #define I2C_MASTER_SDA_IO 4               /*!< gpio number for I2C master data  */    // set the gpio num same to default idf sdk
#define I2C_MASTER_NUM 0 /*!< I2C port number for master dev */    // get it from default idf sdk
